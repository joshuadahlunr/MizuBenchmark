...
const std::array<uint64_t, 100> numbers = {
...
const std::array<uint64_t, 100> sorted = {
...
inline void update_bubble_pointers(opcode* bubble_program, const void* numbers, const void* sorted) {
	bubble_program[9].set_host_pointer_lower_immediate(numbers);
	bubble_program[10].set_host_pointer_upper_immediate(numbers);
	bubble_program[38].set_host_pointer_lower_immediate(sorted);
	bubble_program[39].set_host_pointer_upper_immediate(sorted);
}